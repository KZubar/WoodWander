//
//  SourcePointCollectionCell.swift
//  WoodWander
//
...
final class SourcePointCollectionCell: UICollectionViewCell {
    
    private enum ConstColor {
        static let colorCell: UIColor = .white
        static let colorCellSelected: UIColor = .appBlue.withAlphaComponent(0.25)
    }
